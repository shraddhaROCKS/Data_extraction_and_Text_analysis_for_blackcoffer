...
upload the database (input.xlsx, containing all the URLs) on to your google drive
open google colaboratory in your browser
Mount the drive to your google colaboratory 
mention the path of "input.xlsx" when reading the excel file 
once, you have done the required process import all the required packages into colaboratory and run the code
